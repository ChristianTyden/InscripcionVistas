<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IngresoADMAPP.aspx.vb" Inherits="InscripcionOnline.IngresoADMAPP" %>
        ...
        <asp:Table runat="server" HorizontalAlign="Center" BackColor="#eaeaea" BorderColor="Black" BorderWidth="2px">
            <asp:TableRow HorizontalAlign="Center" BackColor="#333333" ForeColor="White">
                <asp:TableCell ColumnSpan="2">
                    <asp:Label ID="lbl1" runat="server" Text="Ingreso a Administracion" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
            ...
            <asp:TableRow HorizontalAlign="Center" BackColor="#333333" ForeColor="White">
                <asp:TableCell>
                    <asp:Button ID="btnIngresar" runat="server" Text="Ingresar" CssClass="btn btn-secondary" BackColor="Green" BorderColor="Black" ForeColor="White" Font-Size="XX-Large" />
                </asp:TableCell>
                <asp:TableCell>
                    <asp:Button ID="btnCerrar" runat="server" Text="Cerrar" CssClass="btn btn-secondary" BackColor="Red" BorderColor="Black" ForeColor="White" Font-Size="XX-Large" />
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>

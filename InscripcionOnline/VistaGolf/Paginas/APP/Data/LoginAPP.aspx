<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LoginAPP.aspx.vb" Inherits="InscripcionOnline.LoginAPP" %>
...
<body style="font-family:Verdana; font-size:xx-large">
    <form id="form1" runat="server">
        ...
        <asp:Table runat="server" HorizontalAlign="Center" Width="80%" BorderColor="Black" BorderWidth="2px" BackColor="#eaeaea">
            ...
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                    <asp:Button ID="btnIngresar" runat="server" Text="Ingresar" Width="80%" CssClass="btn btn-secondary" BackColor="Green" BorderColor="Black" ForeColor="White" Font-Size="XX-Large" Height="100px" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow><asp:TableCell ColumnSpan="2" HorizontalAlign="Center"><hr width="80%"/></asp:TableCell></asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                    <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" Width="80%" CssClass="btn btn-secondary" BackColor="Red" BorderColor="Black" ForeColor="White" Font-Size="XX-Large" Height="100px" />                
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow><asp:TableCell ColumnSpan="2" HorizontalAlign="Center"><hr width="80%"/></asp:TableCell></asp:TableRow>
            <asp:TableRow HorizontalAlign="Center" BackColor="#333333" ForeColor="White" >
                <asp:TableCell ColumnSpan="2">
                    <asp:Table runat="server" HorizontalAlign="Center" Width="100%">
                        <asp:TableRow HorizontalAlign="Center">
                            ...
                            <asp:TableCell>
                                <asp:HyperLink ID="hlOlvideClave" NavigateUrl="OlvideMiClaveAPP.aspx" runat="server" Text="Olvide mi Clave" />
                            </asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
                </asp:TableCell>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <asp:Button runat="server" ID="popbtn" Text="Extender" CssClass="btn btn-primary" Font-Size="XX-Large" />
                    </div>
                </div>
            </div>
        </div>

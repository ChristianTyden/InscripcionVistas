<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ABMAPP.aspx.vb" Inherits="InscripcionOnline.ABMAPP" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Table runat="server" HorizontalAlign="Center" Width="90%" BackColor="#eaeaea" BorderColor="Black" BorderWidth="2px">
            ...
            <asp:TableRow HorizontalAlign="Center" BackColor="#333333">
                <asp:TableCell>
                    <asp:Button ID="btnAceptar" runat="server" Text="Aceptar" CssClass="btn btn-secondary" BackColor="Green" BorderColor="Black" ForeColor="White" Font-Size="XX-Large" />
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </form>

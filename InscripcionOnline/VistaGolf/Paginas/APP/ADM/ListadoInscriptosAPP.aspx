<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ListadoInscriptosAPP.aspx.vb" Inherits="InscripcionOnline.ListadoInscriptosAPP" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Table runat="server" HorizontalAlign="Center" Width="60%">
            <asp:TableRow HorizontalAlign="Center">
                <asp:TableCell>
                    <asp:Button runat="server" ID="Volver" Text="Volver" CssClass="btn btn-secondary" BackColor="Red" BorderColor="Black" ForeColor="White" Font-Size="XX-Large" Width="80%" />                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        <br />

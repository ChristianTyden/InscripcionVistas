<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ListadoCanceladosAPP.aspx.vb" Inherits="InscripcionOnline.ListadoCanceladosAPP" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Table runat="server" HorizontalAlign="Center" Width="90%">
            <asp:TableRow HorizontalAlign="Center">
                <asp:TableCell>
                    <asp:Button ID="Volver" Text="Volver" runat="server" CssClass="btn btn-secondary" BackColor="Red" BorderColor="Black" ForeColor="White" Font-Size="XX-Large" Width="80%" /><br /><br />                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        <br />

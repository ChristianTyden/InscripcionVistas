<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ListadoUsuariosBorradosAPP.aspx.vb" Inherits="InscripcionOnline.ListadoUsuariosBorradosAPP" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Table runat="server" HorizontalAlign="Center" Width="60%">
            <asp:TableRow HorizontalAlign="Center">
                <asp:TableCell>
                    <asp:Button runat="server" ID="Volver" Text="Volver" CssClass="btn btn-secondary" BackColor="Red" BorderColor="Black" ForeColor="White" Font-Size="XX-Large" Width="80%" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow HorizontalAlign="Center">
                <asp:TableCell>
                    <br />
                    <asp:Button runat="server" ID="btnUsuarios" Text="Mostrar Todos" CssClass="btn btn-secondary" BorderColor="Black" ForeColor="Black" Font-Size="XX-Large" Width="80%" /><br />
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        <br />
                ...
                <asp:TableCell>
                    <asp:DataGrid ID="DataGrid" runat="server" AutoGenerateColumns="False" Width="80%" ForeColor="White" BackColor="#333333">
                        <Columns>
                            ...
                            <asp:BoundColumn HeaderText="EMAIL" DataField="Mail" ItemStyle-BackColor="#eaeaea" ItemStyle-ForeColor="Black" Visible="false" />
                            ...
                            <asp:ButtonColumn HeaderText="" ButtonType="PushButton" Text="Recuperar" ItemStyle-HorizontalAlign="Center" CommandName="RecuperarUsuario" ItemStyle-BackColor="#eaeaea" ItemStyle-ForeColor="Black" />
                        </Columns>
                    </asp:DataGrid>
                </asp:TableCell>
            </asp:TableRow>

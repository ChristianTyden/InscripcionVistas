<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ListadoUsuariosAPP.aspx.vb" Inherits="InscripcionOnline.ListadoUsuariosAPP" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Table runat="server" HorizontalAlign="Center" Width="60%">
            ...
            <asp:TableRow HorizontalAlign="Center">
                <asp:TableCell>
                    <br />
                    <asp:Button runat="server" ID="btnBorrados" Text="Usuarios Eliminados" CssClass="btn btn-secondary" BorderColor="Black" ForeColor="Black" Font-Size="XX-Large" Width="80%" /><br />
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        <br />
                ...
                <asp:TableCell>
                    <asp:DataGrid ID="DataGrid" runat="server" AutoGenerateColumns="False" Width="80%" ForeColor="White" BackColor="#333333">
                        <Columns>
                            ...
                            <asp:ButtonColumn HeaderText="" ButtonType="PushButton" Text="Borrar" ItemStyle-HorizontalAlign="Center" CommandName="BorrarUsuario" ItemStyle-BackColor="#eaeaea" ItemStyle-ForeColor="Black" />
                        </Columns>
                    </asp:DataGrid>
                </asp:TableCell>
            </asp:TableRow>

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InfoTorneo.aspx.vb" Inherits="InscripcionOnline.InfoTorneo" %>
...
<body style="font-family:Verdana;">
    <form id="form1" runat="server">
        ...
        <asp:Table ID="tbTorneo" runat="server" HorizontalAlign="Center" BackColor="#e8e8e8" BorderColor="Black" BorderWidth="2px">
            <asp:TableRow>
            ...
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Center">
                    <asp:Button ID="Button1" runat="server" Text="Volver" CssClass="btn btn-secondary" BackColor="Red" BorderColor="Black" ForeColor="White" PostBackUrl="Home.aspx" />
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </form>

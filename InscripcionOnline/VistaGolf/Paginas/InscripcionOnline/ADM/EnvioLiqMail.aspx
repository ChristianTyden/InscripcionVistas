<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EnvioLiqMail.aspx.vb" Inherits="InscripcionOnline.EnvioLiqMail" %>on
...
<body style="font-family:Verdana;">
    <form id="form1" runat="server">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <asp:Button runat="server" class="close" Text="×" BackColor="White" BorderColor="White" CssClass="close" />
                    </div>
        ...
        <br />
        <asp:Table ID="Table1" runat="server" Width="90%" HorizontalAlign="Center" BackColor="#eaeaea" BorderColor="Black" BorderWidth="2px">
            <asp:TableRow>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Left">
                    <asp:TextBox ID="txtMensaje" runat="server" TextMode="MultiLine" Height="196px" Width="100%" /><br /><br />
                </asp:TableCell>
            </asp:TableRow>
                ...
                <asp:TableCell ColumnSpan="2">
                    <asp:Table runat="server" HorizontalAlign="Center" Width="50%">
                        <asp:TableRow HorizontalAlign="Center">
                            <asp:TableCell>
                                <asp:Button ID="btnEnviar" Text="Enviar Mail" runat="server" CssClass="btn btn-secondary" BorderColor="Black" Width="70%" />
                            </asp:TableCell>
                            <asp:TableCell>
                                <asp:Button ID="btnTildar" Text="Tildar / Destildar" runat="server" CssClass="btn btn-secondary" BorderColor="Black" Width="70%" />
                            </asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
                </asp:TableCell>
